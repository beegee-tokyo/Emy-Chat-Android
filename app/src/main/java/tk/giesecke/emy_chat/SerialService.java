...
public class SerialService extends Service implements SerialListener {
	...
	private void createNotification() {
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
			NotificationChannel nc = new NotificationChannel(Constants.NOTIFICATION_CHANNEL, Constants.NOTIFICATION_CHANNEL, NotificationManager.IMPORTANCE_DEFAULT);
	...
	private void showMsgNotification(byte[] data) {
		if ((data[0] == cCHAT_TYPE) || (data[0] == cNAME_TYPE)) {
